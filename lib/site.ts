...
export const SITE = {
  ...
  // 토스 심사: 푸터 주소는 사업자등록증과 글자 단위로 같아야 한다.
  // 2026-09-04 파주세무서 정정 발급 등록증 표기 그대로 (1_사업서류/사업자등록증_정정_파주_2026-09-04.pdf)
  address: "경기도 파주시 고봉로 755-27, 201-138호 갤러리하우스상가(상지석동)",
