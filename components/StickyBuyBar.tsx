...
export default function StickyBuyBar({
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-line bg-card/95 px-4 pb-[max(env(safe-area-inset-bottom),12px)] pt-3 backdrop-blur">
      <div className="mx-auto flex max-w-xl items-center gap-3">
        <div className="min-w-0">
          ...
          <p className="text-[15px] font-bold text-accent-strong">
            {discounted && (
              <span className="mr-1.5 text-xs font-normal text-ink-soft line-through">
        ...
        <Link
          ...
          className="flex-1 rounded-xl bg-accent-strong px-4 py-3.5 text-center text-[15px] font-bold text-white transition hover:opacity-90"
        >
